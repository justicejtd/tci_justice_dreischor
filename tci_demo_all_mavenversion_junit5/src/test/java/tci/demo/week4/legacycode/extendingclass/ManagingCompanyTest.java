...
class ManagingCompanyTest {
     ...
     * );
     * -> at tci.demo.week4.legacycode.originalcode.ManagingCompanyTest.shouldAddNewZebraToZoo(ManagingCompanyTest.java:22)
    ...
    public void shouldAddNewZebraToZoo() {
        ...
        ExtendedZebra expectedZebra = new ExtendedZebra(VALID_STRIPES_NUMBER);
        // act
